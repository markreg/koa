...
app.request = function(obj){
  var ctx = this.Request.prototype;
  var names = Object.getOwnPropertyNames(obj);

  debug('request: %j', names);
  names.forEach(function(name){
    if (Object.getOwnPropertyDescriptor(ctx, name)) {
      debug('request: overwriting %j', name);
    }
    var descriptor = Object.getOwnPropertyDescriptor(obj, name);
    Object.defineProperty(ctx, name, descriptor);
  });
...
app.response = function(obj){
  var ctx = this.Response.prototype;
  var names = Object.getOwnPropertyNames(obj);

  debug('response: %j', names);
  names.forEach(function(name){
    if (Object.getOwnPropertyDescriptor(ctx, name)) {
      debug('response: overwriting %j', name);
    }
    var descriptor = Object.getOwnPropertyDescriptor(obj, name);
    Object.defineProperty(ctx, name, descriptor);
  });
